...
1. Once deployed, open `law-sc500-sentinel`
1. Review:
...
1. Select `law-sc500-sentinel` from the list
1. Click **Add Microsoft Sentinel**
1. ✅ Sentinel is now enabled on your workspace
...
1. Search for **Azure Activity**
1. Click **Azure Activity** → **Open connector page**
1. Click **Configure Azure Activity logs**
1. In the Diagnostic settings blade:
...
1. Click **Save**
1. Return to the connector page — status should show **Connected**

### Step 3.2 — Enable Entra ID connector

1. In Data connectors, search for **Microsoft Entra ID**
1. Click **Microsoft Entra ID** → **Open connector page**
1. Under **Connect Logs**, enable:
   - **Sign-in Logs**
   - **Audit Logs**
1. Click **Apply changes**
1. ✅ Status should show logs are flowing
...
1. **Event grouping:** Group all events into a single alert
...
### Step 4.4 — Configure Incident Settings
 ...
 1. Click **Next: Automated response**

### Step 4.5 — Configure Automated Response (optional)

 1. You can leave this empty for now, or add an automation rule to assign incidents automatically
 1. Click **Next: Review** → **Save**
...
1. Search for **Azure Activity**
1. Click it → **View template**
1. ✅ Review the pre-built visualizations (operations over time, top callers, etc.)
1. Click **Save** to create an editable copy
