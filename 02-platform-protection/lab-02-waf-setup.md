...
2. **Basics:**
   ...
   - **Location:** East US
3. Click **Next: Policy settings**

### Step 1.2 — Configure WAF Policy Settings

4. **Policy mode:** Prevention
5. **Inspect request body:** Enabled
6. **Max request body size (KB):** 128
7. **File upload limit (MB):** 100
8. Click **Next: Managed rules**

### Step 1.3 — Configure Managed Rules

9. **Managed rule set:** OWASP 3.2
10. Leave all rule groups enabled (default)
11. Click **Next: Custom rules**

### Step 1.4 — Add a Custom Rate-Limiting Rule

12. Click **+ Add custom rule**
13. Configure:
    ...
    - **Action:** Block
14. Click **Add**
15. Click **Next: Association** → **Next: Tags** → **Review + create** → **Create**
...
4. **Frontend IP address type:** Public
5. **Public IP address:** Create new → Name: `pip-agw-sc500` → OK
...
11. Click **+ Add a routing rule**
12. **Rule name:** `rule-http-to-backend`
13. **Priority:** 100
14. **Listener:**
...
15. **Backend targets:**
    ...
    - **Backend settings:** Add new:
      ...
      - Protocol: HTTP
      - Port: 80
16. Click **Add** → **Next: Tags** → **Next: Review + create** → **Create**
...
2. Under WAF Policy, select `waf-policy-sc500`
3. Click **Save**
...
2. **Name:** `diag-agw-sc500`
3. Check:
   - **ApplicationGatewayAccessLog**
   - **ApplicationGatewayFirewallLog**
4. **Destination:** Send to Log Analytics workspace
...
2. Click **Logs** and run this KQL query:
...
3. ✅ You should see log entries for the blocked SQLi and XSS attempts
